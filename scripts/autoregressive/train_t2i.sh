...
torchrun --nnodes=1 --nproc_per_node=8 --node_rank=0 \
    ...
    --image-token-path /home/jovyan/zfd/datasets/code-t2i-imagenet-E31/image_token/imagenet512_codes \
    --text-token-path /home/jovyan/zfd/datasets/code-t2i-imagenet-E31/text_token \
